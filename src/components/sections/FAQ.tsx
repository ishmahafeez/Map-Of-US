  ...
  return (
    <section className="flex flex-col items-center px-[205px] py-[70px] max-md:px-[100px] max-sm:px-5">
      ...
      <div className="w-full max-w-[838px]">
        <FAQItem question="What is the process to Map Of US?" />
        <FAQItem question="What makes Map Of Us stand out from the crowd?" />
        <FAQItem question='What do you mean by "Locations"?' />
        <FAQItem
